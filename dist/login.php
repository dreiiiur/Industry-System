    ...
    <div class="max-w-lg mx-auto w-full">
        <div class="bg-white p-12 rounded-lg shadow-lg">
            <form method="POST" class="gap-5">
                <h2 class="text-3xl font-bold mb-2 text-center text-gray-600">Login</h2>
                <div class="space-y-2">
                    <label for="email" class="block text-gray-500">Email</label>
                    <input type="email" name="email" id="email" required class="block w-full px-4 py-3 border-2 border-gray-200 rounded-md">
                <div class="space-y-2">
                    <label for="password" class="block text-gray-500">Password</label>
                    <input type="password" name="password" id="password" required class="block w-full px-4 py-3 border-2 border-gray-200 rounded-md">
                </div>
